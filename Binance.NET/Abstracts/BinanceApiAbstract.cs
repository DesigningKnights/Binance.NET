...
{
    /// <summary>
    /// The binance api abstract.
    /// </summary>
    public abstract class BinanceApiAbstract
    {
        ...
        public BinanceApiAbstract(string apiKey, string apiSecret, string apiUrl, string webSocketEndpoint, bool addDefaultHeaders = true)
        {
